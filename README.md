<img src="docs/images/cofread.svg" width="300" alt="Coffee Reader v.0.9">
...
[Download installation .apk file from here](../../releases) onto your Android device and tap coffereader_###.apk with the highest version number. Ignore all the warnings (the app comes from outside Google store, hence the system admonitions) and install the app.

### Contact and tests reports

I will greatly appreciate your remarks and suggestions after testing. Find me here:
...
Coffee Reader was mainly AI coded by GPT-6 Astra, directed and corrected by Dariusz Zen Żukowski as a product owner (c) 2026. 
It is free for private use until it changes. Any licensing changes will be posted here. All the graphic materials & icons were done personally by the author.
